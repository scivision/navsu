...
% also generate epoch und constInds
dataEpochs = pvt.GPS_seconds ...
           + pvt.GPS_week_num * 604800 ...
           + pvt.Epoch_interval .* (0:pvt.NumEpochs-1)';
pvt.epochs = repelem(dataEpochs, pvt.NumSV, 1);
pvt.constellation = ones(size(pvt.epochs));
