function [GPSweek, GPSsecond, GPSweekday,leapSeconds] = utc2gps(utc_time, useLeepSecond)
% [GPSweek, GPSsecond] = utc2gps(utc_time, leepSecond)
...
%   useLeepSecond - boolean scalar. If "ture" then leap seconds will be
